...
import { Trophy, Users, Plus, Check, X, Calendar } from "lucide-react"
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid gap-8 lg:grid-cols-3">
        ...
        <div className="lg:col-span-2 space-y-6">
          {leaderboards.length === 0 ? (
            <div className="flex flex-col items-center justify-center rounded-3xl bg-card py-20 text-center border border-border/40 shadow-sm">
              <div className="mb-4 flex h-14 w-14 items-center justify-center rounded-2xl bg-secondary">
                <Users className="text-muted-foreground h-6 w-6" />
              </div>
              <p className="text-base font-semibold text-foreground">No Shared Leaderboards Yet</p>
              <p className="mt-1.5 max-w-sm text-xs text-muted-foreground/80 leading-relaxed">
                Add a habit with the same name as a friend, or invite friends to track a new goal together using the button above.
              </p>
            </div>
          ) : (
            leaderboards.map((lb) => (
      ...
      <ResponsiveDialog
        ...
        description="Type a goal name and select friends to invite. Accepting the challenge will add the goal to their dashboard too."
      >
        <div className="space-y-4 pt-2">
          ...
          <div className="space-y-2">
            ...
            <Input
              type="text"
              placeholder="e.g. Read 15 Mins, Run 5k, Meditate"
              value={newGoalName}
